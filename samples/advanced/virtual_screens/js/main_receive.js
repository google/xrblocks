...
document.addEventListener('DOMContentLoaded', function () {
  ...
  options.setAppTitle('Virtual Screens');
  options.setAppDescription('Share desktop windows as movable XR screens.');
