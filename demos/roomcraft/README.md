...
Older builds used separate network identities for physical and virtual views. Save any local work, reload all participants onto the updated build, then Start a new room and share its code. A page still running the older code will not join the new shared namespace.
