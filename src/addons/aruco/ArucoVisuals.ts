...
import {DEFAULT_ARUCO_MARKER_SIZE_METERS} from './ArucoTypes';
 ...
 */
export function createArucoAnchorVisuals(
  options: ArucoAnchorVisualsOptions = {}
): ArucoAnchorVisuals {
  const {
    markerSizeMeters = DEFAULT_ARUCO_MARKER_SIZE_METERS,
  ...
  const group = new THREE.Group() as ArucoAnchorVisuals;
