...
export const ARUCO_DICTIONARY_SIZES: Readonly<
  Record<ArucoDictionaryName, number>
> = {
  ARUCO_MIP_36h12: 250,
  ARUCO: 1023,
};
 ...
 */
export const DEFAULT_ARUCO_DICTIONARY: ArucoDictionaryName = 'ARUCO_MIP_36h12';

/** Default marker selected by the demo. */
export const DEFAULT_ARUCO_MARKER_ID = 0;
 ...
 */
export const DEFAULT_ARUCO_MARKER_SIZE_METERS = 0.15;
 ...
 * self-host.
 */
export const DEFAULT_ARUCO_MODULE_URLS: Readonly<ArucoModuleUrls> = {
...
export type ArucoTrackingState =
  | 'initializing'
  | 'searching'
  | 'tracked'
  | 'anchored'
