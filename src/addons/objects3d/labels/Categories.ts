...
export const TINY_FLAT_LABEL_RE =
 ...
 */
export function isSurfaceLabel(label: string | null | undefined): boolean {
 ...
 */
export function isFlatLabel(label: string | null | undefined): boolean {
 ...
 */
export function isTinyFlatLabel(label: string | null | undefined): boolean {
 ...
 */
export function categorize(label: string | null | undefined): ObjectCategory {
