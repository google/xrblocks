...
For templates and complete projects, see <CodeSearchLink path="templates/6_ai_query/index.html"/>, <CodeSearchLink path="templates/7_ai_live_assistant/index.html"/>, or the advanced poetry sample <CodeSearchLink path="samples/xr_ai/xrpoet/index.html"/>.
