...
For templates and complete projects, see <CodeSearchLink path="templates/6_ai/index.html"/>, <CodeSearchLink path="templates/7_ai_live/index.html"/>, or the advanced poetry sample <CodeSearchLink path="samples/xr_ai/xrpoet/index.html"/>.
