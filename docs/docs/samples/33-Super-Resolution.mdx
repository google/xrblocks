...
This demo uses the live device camera or desktop simulator view as a viewfinder. Choose a center crop size, press **Enhance**, and the page captures that square with `deviceCamera.getSnapshot({outputFormat: 'imageData'})`.
